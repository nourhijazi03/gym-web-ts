...
const ContactUs = ({setSelectedPage}: Props) => {
    const inputStyles=`w-full mb-5 rounded-lg border bg-primary-300 px-5 py-3
    placeholder-white`
    const{
        register,
        trigger,
           ...
           <div className='mt-10 justify-between gap-8 md:flex'>
            ...
            variants={{
             ...
             visible:{opacity:1 ,y:0}
                ...
                onSubmit={onSubmit}
                method="POST"
                action='https://formsubmit.co/nour.alhoda.hjz@gmail.com'>
                    ...
                    {errors.message &&(
                        <p className='mt-1 text-primary-500 '>
                            ...
                            {errors.message.type==="maxLength" && "Max length is 100 character."}
                        </p>
                    )}
                ...
                variants={{
                 ...
                 visible:{opacity:1 ,y:0}
                    ...
                    before:-bottom-20 before:-right-20 z-[-1]'>
